...
import com.opencloud.device.model.ErrorCode;
...
public class GlobalExceptionHandler {
    ...
    public static ResultBody resolveException(Exception e, String path) {
        ...
        if(message!=null) {
            try {
                errorObj = JSONObject.parseObject(message);
        ...
        if (errorObj!=null) {
            ...
            code = ErrorCode.getResultEnum(message);
            message = errorObj.getString("path")+" " +errorObj.getString("error");
        }else{
            code = ErrorCode.getResultEnum(message);
        }
