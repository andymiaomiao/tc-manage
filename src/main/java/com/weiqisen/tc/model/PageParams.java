...
public class PageParams extends Page implements Serializable {
    ...
    public PageParams(Map map) {
        ...
        this.limit = Integer.parseInt(map.getOrDefault(CommonConstants.PAGE_SIZE_KEY, CommonConstants.DEFAULT_LIMIT).toString());
        ...
        map.remove(CommonConstants.PAGE_SIZE_KEY);
